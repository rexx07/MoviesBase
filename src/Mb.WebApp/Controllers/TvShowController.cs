...
using Mb.Application.TvShows.Models;
using Microsoft.AspNetCore.Mvc;

namespace Mb.WebApp.Controllers;

[Authorize]
public class TvShowController : ApiControllerBase
{
    [HttpGet]
    public async Task<ActionResult<PaginatedList<TvShowDto>>> GetMoviesWithPagination(
