        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    MovieIds = table.Column<List<Guid>>(type: "uuid[]", nullable: false),
                    TvShowIds = table.Column<List<Guid>>(type: "uuid[]", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    MovieIds = table.Column<List<Guid>>(type: "uuid[]", nullable: false),
                    TvShowIds = table.Column<List<Guid>>(type: "uuid[]", nullable: false),
                    IsCast = table.Column<bool>(type: "boolean", nullable: false),
                    Created = table.Column<DateTime>(type: "timestamp with time zone", nullable: false),
                    CreatedBy = table.Column<string>(type: "text", nullable: true),
                    LastModified = table.Column<DateTime>(type: "timestamp with time zone", nullable: true),
                    LastModifiedBy = table.Column<string>(type: "text", nullable: true)
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ProductionCompanies = table.Column<List<string>>(type: "text[]", nullable: false),
                    ProductionCountries = table.Column<List<string>>(type: "text[]", nullable: false),
                    ProductionCost = table.Column<double>(type: "double precision", nullable: false),
                    ...
                    VoteCount = table.Column<float>(type: "real", nullable: false),
                    Created = table.Column<DateTime>(type: "timestamp with time zone", nullable: false),
                    CreatedBy = table.Column<string>(type: "text", nullable: true),
                    LastModified = table.Column<DateTime>(type: "timestamp with time zone", nullable: true),
                    LastModifiedBy = table.Column<string>(type: "text", nullable: true)
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Popularity = table.Column<float>(type: "real", nullable: false),
                    OriginCountries = table.Column<List<string>>(type: "text[]", nullable: false),
